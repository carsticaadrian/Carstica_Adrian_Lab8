...
namespace Carstica_Adrian_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Carstica_Adrian_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Carstica_Adrian_Lab8Context context,
